...
The Node-based Pi SDK service lives in the repository-level `pi-agent-service/` directory. Ava routes substantive requests to a persistent chief Pi session, which can delegate bounded tasks to ephemeral workers. Run and configure the complete project through the [project README](../../../README.md).
